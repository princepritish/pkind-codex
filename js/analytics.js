/* =====================================================================
   ...
   and redeploy. While it is empty this file does nothing at all - no
   network requests, no cookies, no performance cost.
...
(function () {
  ...
  // Track the actions that actually matter for this site
  ...
  if (form) form.addEventListener('submit', function () { gtag('event', 'generate_lead'); });
})();
